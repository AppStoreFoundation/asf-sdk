...
import static cm.aptoide.pt.web3j.abi.datatypes.Type.MAX_BIT_LENGTH;
import static cm.aptoide.pt.web3j.abi.datatypes.Type.MAX_BYTE_LENGTH;
...
public class TypeEncoder {
  ...
  @SuppressWarnings("unchecked") public static String encode(Type parameter) {
  ...
  static String encodeString(Utf8String string) {
    byte[] utfEncoded = string.getValue()
