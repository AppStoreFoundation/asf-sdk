...
public class TransactionByHashResponse {
	...
	public class Result {
		...
		public String toString() {
			return "Result{" + "blockHash='" + blockHash + '\'' + ", blockNumber='" + blockNumber + '\''
							+ ", condition=" + condition + ", creates=" + creates + ", from='" + from + '\'' +
							", gas='" + gas + '\'' + ", gasPrice='" + gasPrice + '\'' + ", hash='" + hash + '\''
							+ ", input='" + input + '\'' + ", networkId=" + networkId + ", nonce='" + nonce +
							'\'' + ", publicKey='" + publicKey + '\'' + ", r='" + r + '\'' + ", raw='" + raw +
							'\'' + ", s='" + s + '\'' + ", standardV='" + standardV + '\'' + ", to='" + to +
							'\'' + ", transactionIndex='" + transactionIndex + '\'' + ", v='" + v + '\'' + ", "
							+ "value='" + value + '\'' + '}';
		}
	}
	...
	@Override
	public String toString() {
		return "TransactionByHashResponse{" + "jsonrpc='" + jsonrpc + '\'' + ", result=" + result + "," +
						"" + "" + "" + " id=" + id + '}';
	}
}
