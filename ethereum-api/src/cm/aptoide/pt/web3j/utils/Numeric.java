package cm.aptoide.pt.web3j.utils;

import cm.aptoide.pt.web3j.exceptions.MessageDecodingException;
import cm.aptoide.pt.web3j.exceptions.MessageEncodingException;
...
public final class Numeric {
  ...
  public static byte[] hexStringToByteArray(String input) {
    ...
    for (int i = startIdx; i < len; i += 2) {
      data[(i + 1) / 2] =
          (byte) ((Character.digit(cleanInput.charAt(i), 16) << 4) + Character.digit(
              cleanInput.charAt(i + 1), 16));
    }
    return data;
  }
