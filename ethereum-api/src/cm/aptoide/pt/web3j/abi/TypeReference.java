 ...
 */
public abstract class TypeReference<T extends cm.aptoide.pt.web3j.abi.datatypes.Type>
  ...
  public static <T extends cm.aptoide.pt.web3j.abi.datatypes.Type> TypeReference<T> create(
      Class<T> cls) {
   ...
   */
  @SuppressWarnings("unchecked") public Class<T> getClassType() throws ClassNotFoundException {
  ...
  public abstract static class StaticArrayTypeReference<T extends cm.aptoide.pt.web3j.abi.datatypes.Type>
