...
import cm.aptoide.pt.ethereumj.crypto.ECKey.ECDSASignature;
import cm.aptoide.pt.ethereumj.crypto.ECKey.MissingPrivateKeyException;
import cm.aptoide.pt.ethereumj.crypto.HashUtil;
import cm.aptoide.pt.ethereumj.util.ByteUtil;
import cm.aptoide.pt.ethereumj.util.RLP;
import cm.aptoide.pt.ethereumj.util.RLPElement;
import cm.aptoide.pt.ethereumj.util.RLPItem;
import cm.aptoide.pt.ethereumj.util.RLPList;
...
import static cm.aptoide.pt.ethereumj.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static cm.aptoide.pt.ethereumj.util.ByteUtil.ZERO_BYTE_ARRAY;
...
public class Transaction {
   ...
   * Use {@link Transaction#Transaction(byte[], byte[], byte[], byte[], byte[], byte[], Integer)}
   * constructor instead
  ...
  /**
   * Warning: this transaction would not be protected by replay-attack protection mechanism
   * Use {@link Transaction#Transaction(byte[], byte[], byte[], byte[], byte[], byte[], byte[], *
   * byte[], byte, Integer)}
  ...
  /**
   * @deprecated use {@link Transaction#create(String, BigInteger, BigInteger, BigInteger, *
   * BigInteger, Integer)} instead
   */
