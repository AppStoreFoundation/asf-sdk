...
class EthereumApiImpl implements EthereumApi {
  ...
  @Override
  public Observable<TransactionResultResponse> call(int nonce, String contractAddress, Erc20 erc20,
      ECKey ecKey, long gasPrice, long gasLimit) {
    Transaction transaction =
        contractTransactionFactory.createTransaction(nonce, contractAddress, erc20.encode(), 1,
            gasPrice, gasLimit);
