package cm.aptoide.pt.ethereum.ethereumj.crypto;
...
import cm.aptoide.pt.ethereum.ethereumj.config.Constants;
import cm.aptoide.pt.ethereum.ethereumj.crypto.jce.ECKeyFactory;
import cm.aptoide.pt.ethereum.ethereumj.crypto.jce.ECKeyPairGenerator;
import cm.aptoide.pt.ethereum.ethereumj.crypto.jce.ECSignatureFactory;
import cm.aptoide.pt.ethereum.ethereumj.crypto.jce.SpongyCastleProvider;
...
import static cm.aptoide.pt.ethereum.ethereumj.util.BIUtil.isLessThan;
import static cm.aptoide.pt.ethereum.ethereumj.util.ByteUtil.bigIntegerToBytes;
...
public class ECKey implements Serializable {
   ...
   * @return  -
   */
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey fromPrivate(BigInteger privKey) {
    return new cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey(privKey, CURVE.getG()
        .multiply(privKey));
  }
   ...
   * @return -
   */
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey fromPrivate(byte[] privKeyBytes) {
   ...
   * @return  -
   */
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey fromPrivateAndPrecalculatedPublic(
      BigInteger priv, ECPoint pub) {
    return new cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey(priv, pub);
  }
  ...
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey fromPrivateAndPrecalculatedPublic(
    ...
    return new cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey(new BigInteger(1, priv),
        CURVE.getCurve()
            .decodePoint(pub));
  }
   ...
   * @return -
   */
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey fromPublicOnly(ECPoint pub) {
    return new cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey(null, pub);
  }
   ...
   * @return -
   */
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey fromPublicOnly(byte[] pub) {
    return new cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey(null, CURVE.getCurve()
        .decodePoint(pub));
  }
   ...
   */
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey fromNodeId(byte[] nodeId) {
   ...
   * @return ECKey
   */
  public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey signatureToKey(byte[] messageHash,
      String signatureBase64) throws SignatureException {
   ...
   * @return ECKey
   */
  @Nullable public static cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey recoverFromSignature(
   ...
   * @deprecated per-point compression property will be removed in Bouncy Castle
   */
  public cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey decompress() {
    if (!pub.isCompressed()) {
      return this;
    } else {
      return new cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey(this.provider, this.privKey,
          decompressPoint(pub));
    }
  }
   ...
   * @deprecated per-point compression property will be removed in Bouncy Castle
   */
  public cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey compress() {
    if (pub.isCompressed()) {
      return this;
    } else {
      return new cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey(this.provider, this.privKey,
  ...
  public static class ECDSASignature {
    ...
    public byte[] toByteArray() {
      ...
      return ByteUtil.merge(bigIntegerToBytes(this.r), bigIntegerToBytes(this.s),
          new byte[] { fixedV });
    }
  ...
  @Override public boolean equals(Object o) {
    if (this == o) return true;
    if (o == null || !(o instanceof cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey)) return false;

    cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey ecKey =
        (cm.aptoide.pt.ethereum.ethereumj.crypto.ECKey) o;
