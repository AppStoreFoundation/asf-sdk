package cm.aptoide.pt.ethereum.ws.etherscan.transactionreceipt;
...
@JsonInclude(Include.NON_NULL) @JsonPropertyOrder({
    "blockHash", "blockNumber", "contractAddress", "cumulativeGasUsed", "gasUsed", "logs",
    "logsBloom", "root", "status", "transactionHash", "transactionIndex"
}) public class Result {
