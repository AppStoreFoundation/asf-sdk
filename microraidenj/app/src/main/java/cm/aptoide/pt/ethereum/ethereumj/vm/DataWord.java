...
import cm.aptoide.pt.ethereum.ethereumj.db.ByteArrayWrapper;
import cm.aptoide.pt.ethereum.ethereumj.util.ByteUtil;
import cm.aptoide.pt.ethereum.ethereumj.util.FastByteComparisons;
 ...
 * @since 01.06.2014
 */
public class DataWord implements Comparable<cm.aptoide.pt.ethereum.ethereumj.vm.DataWord> {

  /* Maximum value of the DataWord */
  public static final BigInteger _2_256 = BigInteger.valueOf(2)
      .pow(256);
  public static final BigInteger MAX_VALUE = _2_256.subtract(BigInteger.ONE);
  public static final cm.aptoide.pt.ethereum.ethereumj.vm.DataWord ZERO =
      new cm.aptoide.pt.ethereum.ethereumj.vm.DataWord(new byte[32]);
      // don't push it in to the stack
  public static final cm.aptoide.pt.ethereum.ethereumj.vm.DataWord ZERO_EMPTY_ARRAY =
      new cm.aptoide.pt.ethereum.ethereumj.vm.DataWord(new byte[0]);
      // don't push it in to the stack
  ...
  public cm.aptoide.pt.ethereum.ethereumj.vm.DataWord and(
      cm.aptoide.pt.ethereum.ethereumj.vm.DataWord w2) {
  ...
  public cm.aptoide.pt.ethereum.ethereumj.vm.DataWord or(
      cm.aptoide.pt.ethereum.ethereumj.vm.DataWord w2) {
  ...
  public cm.aptoide.pt.ethereum.ethereumj.vm.DataWord xor(
      cm.aptoide.pt.ethereum.ethereumj.vm.DataWord w2) {
  ...
  public void add(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
  ...
  public void add2(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
  ...
  public void mul(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
    BigInteger result = value().multiply(word.value());
    this.data = ByteUtil.copyToArray(result.and(MAX_VALUE));
  }

  // TODO: improve with no BigInteger
  public void div(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
  ...
  // TODO: improve with no BigInteger
  public void sDiv(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
  ...
  // TODO: improve with no BigInteger
  public void sub(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
    BigInteger result = value().subtract(word.value());
    this.data = ByteUtil.copyToArray(result.and(MAX_VALUE));
  }

  // TODO: improve with no BigInteger
  public void exp(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
    BigInteger result = value().modPow(word.value(), _2_256);
    this.data = ByteUtil.copyToArray(result);
  }

  // TODO: improve with no BigInteger
  public void mod(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word) {
  ...
  public void mulmod(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word1,
      cm.aptoide.pt.ethereum.ethereumj.vm.DataWord word2) {
  ...
  @Override public boolean equals(Object o) {
    ...
    cm.aptoide.pt.ethereum.ethereumj.vm.DataWord dataWord =
        (cm.aptoide.pt.ethereum.ethereumj.vm.DataWord) o;

    return java.util.Arrays.equals(data, dataWord.data);
  }

  public cm.aptoide.pt.ethereum.ethereumj.vm.DataWord clone() {
    return new cm.aptoide.pt.ethereum.ethereumj.vm.DataWord(Arrays.clone(data));
  }
  ...
  @Override public int compareTo(cm.aptoide.pt.ethereum.ethereumj.vm.DataWord o) {
