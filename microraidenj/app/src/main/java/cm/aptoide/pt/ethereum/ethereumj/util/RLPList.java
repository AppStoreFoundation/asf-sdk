...
public class RLPList extends ArrayList<RLPElement> implements RLPElement {
    ...
    public static void recursivePrint(RLPElement element) {
        ...
        if (element instanceof cm.aptoide.pt.ethereum.ethereumj.util.RLPList) {

            cm.aptoide.pt.ethereum.ethereumj.util.RLPList rlpList =
                (cm.aptoide.pt.ethereum.ethereumj.util.RLPList) element;
            System.out.print("[");
