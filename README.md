...
```
dependencies {
    api 'com.asfoundation:appcoins:0.3.3a'
}
```
...
```
dependencies {
    api 'com.asfoundation:appcoins-iab:0.3.3a'
    api 'com.asfoundation:appcoins-ads:0.3.3a'
}
```
...
## Size
As of version [0.3.3a](https://bintray.com/asf/asf/appcoins-ads/0.3.3a), SDK weight is approximately as follows:
