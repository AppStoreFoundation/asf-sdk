 ...
 */
package cm.aptoide.pt.ethereumj.vm;
...
import cm.aptoide.pt.ethereumj.core.Bloom;
...
public class LogInfo {
	...
	public String toString() {
		...
		return "LogInfo{" + "address=" + Hex.toHexString(
						address) + ", topics=" + topicsStr + ", data=" + Hex.toHexString(data) + '}';
	}
}
