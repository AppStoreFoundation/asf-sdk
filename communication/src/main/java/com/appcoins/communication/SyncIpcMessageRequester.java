...
public interface SyncIpcMessageRequester {
   ...
   * @throws MainThreadException Since this is a blocker method and we use activities to
   * communicate(which default methods run on main thread) you can't use main thread to send
